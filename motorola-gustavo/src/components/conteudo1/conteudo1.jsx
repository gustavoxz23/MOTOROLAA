    ...
    return (
        <section className={style.imgCont1}>
            ...
            <div className={style.conteoTextoud}>
                <h2>motorola edge 40 neo 5G 
16GB RAM Boost | 256GB | Caneel Bay - Vegan Leather</h2>
                <p className={style.price}> ̶ ̵̶̵D̵̶̵e̵̶̵:̵̶̵ ̵̶̵R̵̶̵$̵̶̵2̵̶̵.̵̶̵7̵̶̵9̵̶̵9̵̶̵</p>
                <p className={style.Mp}>motorola edge 40 neo 5G 
16GB RAM Boost | 256GB | Caneel Bay - Vegan Leather</p>
